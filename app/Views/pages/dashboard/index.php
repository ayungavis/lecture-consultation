            ...
            <div class="flex">
              ...
              <div class="d-flex align-items-center">
                <div class="progress" style="width: 100px; height:4px;">
                  <div class="progress-bar bg-vuejs" role="progressbar" style="width: 25%" aria-valuenow="25"
        ...
        <li class="list-group-item" style="z-index: initial;">
          <div class="d-flex align-items-center">
            ...
            <div class="flex">
              ...
              <div class="d-flex align-items-center">
                <div class="progress" style="width: 100px; height:4px;">
                  <div class="progress-bar bg-angular" role="progressbar" style="width: 100%" aria-valuenow="100"
                    aria-valuemin="0" aria-valuemax="100"></div>
                </div>
        ...
        <li class="list-group-item">
          <div class="media align-items-center">
            <div class="media-body">
              ...
              <div class="d-flex align-items-center">
                <i class="material-icons icon-16pt text-muted mr-1">queue_play_next</i> <a href="take-course.html"
                  class="small text-muted">Basics of HTML</a>
              </div>
            </div>
        ...
        <li class="list-group-item">
          <div class="media align-items-center">
            <div class="media-body">
              ...
              <div class="d-flex align-items-center">
                <i class="material-icons icon-16pt text-muted mr-1">queue_play_next</i> <a href="take-course.html"
                  class="small text-muted">Angular in Steps</a>
              </div>
            </div>
            <div class="media-right text-center d-flex align-items-center">
        ...
        <li class="list-group-item">
          <div class="media align-items-center">
            <div class="media-body">
              ...
              <div class="d-flex align-items-center">
                <i class="material-icons icon-16pt text-muted mr-1">queue_play_next</i> <a href="take-course.html"
                  class="small text-muted">Bootstrap Foundations</a>
              </div>
            </div>
            <div class="media-right text-center d-flex align-items-center">
  ...
  <div class="col-lg-5">
    ...
    <div class="card">
      ...
      <div class="card-header card-header-tabs-basic nav" role="tablist">
        ...
        <a href="#activity_purchases" data-toggle="tab" role="tab" aria-controls="activity_purchases"
      ...
      <div class="card-body">
        <ul class="list-unstyled list-skills">
          ...
          <li>
            ...
            <div class="flex">
              <div class="progress" style="height: 4px;">
                <div class="progress-bar bg-warning" role="progressbar" style="width: 76%;" aria-valuenow="76"
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          ...
          <li>
            ...
            <div class="flex">
              <div class="progress" style="height: 4px;">
                <div class="progress-bar bg-vuejs" role="progressbar" style="width: 50%;" aria-valuenow="50"
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
